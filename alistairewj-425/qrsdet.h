...
#define MS_PER_SAMPLE	(int) ( 1000/SAMPLE_RATE)
#define CEILING_POS(X) ((X-(int)(X)) > 0 ? (int)(X+1) : (int)(X))
#define MS10	((int) (10/MS_PER_SAMPLE))
#define MS25	((int) (25/MS_PER_SAMPLE))
#define MS30	((int) (30/MS_PER_SAMPLE))
#define MS80	((int) (80/MS_PER_SAMPLE))
#define MS95	((int) (95/MS_PER_SAMPLE))
#define MS100	((int) (100/MS_PER_SAMPLE))
#define MS125	((int) (125/MS_PER_SAMPLE))
#define MS150	((int) (150/MS_PER_SAMPLE))
#define MS160	((int) (160/MS_PER_SAMPLE))
#define MS175	((int) (175/MS_PER_SAMPLE))
#define MS195	((int) (195/MS_PER_SAMPLE))
#define MS200	((int) (200/MS_PER_SAMPLE))
#define MS220	((int) (220/MS_PER_SAMPLE))
#define MS250	((int) (250/MS_PER_SAMPLE))
#define MS300	((int) (300/MS_PER_SAMPLE))
#define MS360	((int) (360/MS_PER_SAMPLE))
#define MS450	((int) (450/MS_PER_SAMPLE))
